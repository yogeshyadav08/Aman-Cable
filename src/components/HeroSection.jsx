...
//                   className="text-white hover:text-gray-200 cursor-pointer text-2xl bg-blue-800 hover:bg-blue-900 rounded-full w-8 h-8 flex items-center justify-center transition-colors"
//                 >
//                   &times;
//                 </button>
//               </div>
...
//                     type="button"
//                     onClick={handleCloseModal}
//                     className="px-5 py-2.5 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors font-medium cursor-pointer"
//                   >
//                     Cancel
//                   </button>
//                   <button
//                     type="submit"
//                     disabled={loading}
//                     className={`px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium flex items-center cursor-pointer justify-center ${
                  ...
                  {customerData?.BillAmount && (
                    <div className="mt-6 pt-5 border-t border-gray-200">
                      ...
                      <div className="flex flex-col items-center bg-gradient-to-br from-blue-50 to-gray-50 p-5 rounded-xl border border-gray-200">
                        ...
                        <div className="text-center">
                          <p className="text-sm text-gray-700 font-medium mb-2">
                            Scan to pay with Google Pay, PhonePe, Paytm, or any
                            UPI app
                          </p>
                          <div className=" items-center justify-center text-sm text-gray-600 bg-blue-50 p-2 rounded-lg">
                            {/* <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-4 w-4 text-blue-500 mr-1"
                              fill="none"
                            ...
                            Please share the payment screenshot by clicking on
                            the number:{" "}
                            <a
                              href="whatsapp://send?phone=918081656353"
